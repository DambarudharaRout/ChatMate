...
const ProfilePage = () => {
  ...
  const [bio, setBio] = useState("Hi Everyone, I am using ChatMate");
    ...
    justify-center'>
      ...
      rounded-lg'>
        <form onSubmit={handleSubmit} className="flex flex-col gap-5 p-10 flex-1">
          ...
          cursor-pointer">
            <input onChange={(e)=>selectedImg(e.target.files[0])} type="file" 
          ...
          rounded-md focus:outline-none focus:ring-2 focus:ring-violet-500' required/>
